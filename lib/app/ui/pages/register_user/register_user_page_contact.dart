...
import 'widgets/register_user_form_contact.dart';

class RegisterUserPageContact extends StatelessWidget {
  const RegisterUserPageContact({Key? key}) : super(key: key);
            ...
            body: Stack(
              children: <Widget>[
                Container(
                  ...
                  child: const RegisterUserFormContact(),
                ),
                Obx(() {

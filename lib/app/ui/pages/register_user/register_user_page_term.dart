...
import 'widgets/register_user_form_term.dart';

class RegisterUserPageTerm extends StatelessWidget {
  const RegisterUserPageTerm({Key? key}) : super(key: key);
            ...
            body: Stack(
              children: <Widget>[
                Container(
                  ...
                  child: const RegisterUserFormTerm(),
                ),
                Obx(() {
